    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_frequency', models.DecimalField(decimal_places=1, max_digits=2, verbose_name='Частота')),
                ('max_frequency', models.DecimalField(decimal_places=1, max_digits=2, verbose_name='Частота в разгоне')),
